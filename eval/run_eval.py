        ...
        for idx, item in enumerate(dataset):
            ...
            chunk_texts = [
                (
                    ...
                    f"Page: {chunk.get('source_page', 'N/A')}\n"
            ...
            hit_rate = (
                1.0 if any(evaluator._normalize_course_code(c) == target_norm for c in retrieved_courses[:5]) else 0.0
            )
            ...
            try:
                ...
                rag_system_prompt = (
                    ...
                    "Your sole task is to answer the user's question using ONLY the provided context.\n"
                    "RULES:\n"
                    "1. If the answer cannot be explicitly found in the context, "
                    "output EXACTLY: 'I cannot answer based on the provided context.' Do not guess.\n"
...
This report presents the rigorous evaluation of the Sage offline-first Academic Assistant.
Evaluated using a dataset of {len(dataset)} academic queries against actual indexed curriculum data.
