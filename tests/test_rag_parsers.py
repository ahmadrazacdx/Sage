...
from sage.rag.corpus import DocumentMetadata  # noqa: E402
from sage.rag.parsers import (  # noqa: E402
    PageBlock,
...
def test_parse_pdf(tmp_path, dummy_meta):
    ...
    doc2 = parse_pdf(
        pdf_file, dummy_meta, min_chars_per_page=5, ocr_engine="tesseract", ocr_dpi=300, ocr_language="eng"
    )
