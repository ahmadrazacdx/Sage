...
from sage.agents.planner import planner_node, RoadmapAnalysis, RoadmapSchedule
...
async def test_quiz_node_evaluate():
    state: AgentState = {
        "query": "1. 2\n2. 4",
        "intent": "quiz",
        "last_quiz_questions": '[{"id": 1, "type": "short_answer", "question": "1+1?", "answer": "2", "explanation": "", "bloom_level": "Understand", "options": null}]'
    }
    llm = create_mock_llm(AIMessage(content='```json\n{"score": "1/1", "percentage": 100.0, "results": [{"id": 1, "correct": true, "student_answer": "2", "correct_answer": "2", "explanation": "", "misconception": null, "review_topic": null}], "summary": {"strengths": [], "gaps": [], "recommended_review": []}}\n```'))
...
def test_quiz_parsing_logic():
    from sage.agents.quiz import _extract_json, _parse_quiz, _validate_quiz, QuizOutput, QuizQuestion, _looks_like_answers
