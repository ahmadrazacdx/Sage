...
from sage.agents.research import _replace_placeholder_references, _build_fallback_references
...
async def test_run_digest_phase_logic():
    from sage.agents.research import _run_digest_phase, ResearchPlan, Subtopic, ContextBudget
